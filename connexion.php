...
<html lang="fr">
    ...
    <body>
        ...
        <div class="nos-menus-banner">
            ...
            <h1>Bon retour  <em> & connexion </em></h1></div>
        </div>
                            ...
                            <div class="auth-fields">
                                ...
                                <div class="password-wrapper">
                                    ...
                                    <button type="button" id="toggle-password" class="btn-eye">
                                        <!-- Oeil ouvert -->
                                        <svg aria-label="Afficher/Masquer le mot de passe" id="eye-icon" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
