...
(27, 57, '2026-07-11 19:30:00', 'en_attente', 'devis', 'Quinsac, France', 'chez l\'utilisateur', NULL, NULL, '2026-06-22', '', 156.86, 97.55, 0, 0, NULL);
...
INSERT INTO `menu` (`Id_menu`, `menu_nom`, `theme`, `regime`, `nb_perso_min`, `nb_perso_max`, `prix_menu`, `entree`, `plat`, `dessert`, `boisson`, `allergene`, `description`, `entree_description`, `plat_description`, `dessert_description`, `boisson_description`, `img_menu`, `link`, `description_info`, `img_uploaded`, `actif`, `quantite_restante`, `conditions`) VALUES
